...
var questions = [
    ...
    {
        title:"Who developed object-oriented programming?",
    ...
    {
        title:"Which feature of OOPS described the reusability of code?",
        options: ["Abstraction", "Encapsulation", "Polymorphism","Inheritance"],
        answer: "Inheritance"

    },
    {
        title:"A single program of OOPS contains _______ classes?",
        options: ["Only 1", "Only 999", "Only 100","Any number"],
        answer: "Any number"

    },
    {
        title:"Which of the following feature is also known as run-time binding or late binding?",
        options: ["Dynamic typing", "Dynamic loading", "Dynamic binding","Data hiding"],
        answer: "Dynamic binding"

    },
    {
        title:" Which of the following variable violates the definition of encapsulation?",
        options: ["Array variables", "Local variables", "Global variables","Public variables"],
        answer: "Global variables"

    },
    {
        title:"  What does the expression float a = 35 / 0 return?",
